...
if __name__ == "__main__":
    ...
    # init model
    model = BPR(G, data_name, embedding_size=args.emb_size, negative_ratio=args.negative_ratio,
    ...
    np.savez('./saved_embeddings/BPR_{}_Final'.format(data_name), embeddings)
